...
import 'package:flutter_apptest/firebase/firebase_storage.dart';
import 'package:flutter_apptest/isolates/resize_image.dart';
import 'package:flutter_apptest/main.dart';
import 'package:flutter_apptest/utils/post_path.dart';
import 'package:flutter_apptest/widgets/my_progress_indicator.dart';
import 'package:flutter_tags/flutter_tags.dart';
import 'package:flutter_apptest/widgets/share_switch.dart';
...
class SharePostPage extends StatefulWidget {
  ...
  const SharePostPage({Key key, @required this.imgFile, @required this.postKey}) : super(key: key);
  @override
...
class _SharePostPageState extends State<SharePostPage> {
  ...
  void _uploadImageNCreateNewPost() async {
    ...
    try {
      ...
      await storageProvider.uploadImg(
          resized, getImgPath(widget.postKey));
      setState(() {
